...
/**
 * Populates the DataStore with all sample data required by the coursework: - 5 exercise types (4+ required) - 10
 * members (10 required) - 8 weekends × 2 days × 3 slots = 48 lessons (48 required) - bookings linking members to
 * lessons - 20+ reviews with ratings
 */
public class SampleData {
    ...
    private static void book(DataStore store, String bookingId, Member member, String lessonId) {
        ...
        if (lesson == null)
            throw new IllegalStateException("Lesson not found: " + lessonId);
    ...
    private static void review(DataStore store, String reviewId, String memberId, String lessonId, int rating,
            String comment) {
