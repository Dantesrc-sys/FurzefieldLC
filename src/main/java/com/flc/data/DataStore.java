...
/**
 * Central in-memory data store for Furzefield Leisure Centre.
 * Holds all lists of members, exercise types, lessons, bookings, and reviews.
 * Single instance shared across the whole application (Singleton).
 */
public class DataStore {
    ...
    public void addExerciseType(ExerciseType e) {
        if (e == null) throw new IllegalArgumentException("ExerciseType cannot be null");
    ...
    public List<Lesson> findLessonsByDayAndWeek(Day day, int weekNumber) {
        return lessons.stream()
                .filter(l -> l.getDay() == day && l.getWeekNumber() == weekNumber)
                .toList();
    }
    ...
    public void addReview(Review r) {
        if (r == null) throw new IllegalArgumentException("Review cannot be null");
    ...
    public int getTotalReviews()       { return reviews.size();       }
    public int getTotalExerciseTypes() { return exerciseTypes.size(); }
}