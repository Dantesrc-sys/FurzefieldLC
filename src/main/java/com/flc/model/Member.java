 ...
 *
 * <p>Each member has a unique immutable ID generated by
 * {@link com.flc.controller.MemberController}, a mutable name, and a mutable
 * phone number. Members can be enrolled in lessons, make bookings, and submit
 * reviews for lessons they have attended.</p>
 *
 * <p>Equality is based solely on {@code memberId} - two {@code Member} objects
 * with the same ID are considered equal regardless of name or phone.</p>
 *
 * @see com.flc.controller.MemberController
 * @see com.flc.model.Booking
 * @see com.flc.model.Review
 */
public class Member {
