...
/**
 * Central theme configuration for Furzefield Leisure Centre.
 * Every colour, font, size, spacing, shadow, and border lives here.
 * Never hardcode a visual value anywhere else — always reference this class.
 */
