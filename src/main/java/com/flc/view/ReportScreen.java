...
/**
 * Screen displaying the two season summary reports.
 *
 * <p>Shows two side-by-side reports generated by
 * {@link com.flc.controller.ReportController}:</p>
 * <ul>
 *   <li>Attendance and rating report - one row per lesson, sorted by week,
 *       day, and time slot, showing enrolled count and average review rating.</li>
 *   <li>Income by exercise report - one row per exercise type, sorted by total
 *       income descending, with the top earner highlighted in a badge.</li>
 * </ul>
 *
 * <p>Both reports are read-only and regenerated fresh on every visit to
 * this screen.</p>
 */
