...
public class MemberController {
     ...
     * @throws IllegalArgumentException if name or phone is blank
    ...
    public void updatePhone(Member member, String newPhone) {
        ...
        if (newPhone == null || newPhone.isBlank()) throw new IllegalArgumentException("Phone cannot be empty");
    ...
    public void updateName(Member member, String newName) {
        if (member  == null)             throw new IllegalArgumentException("Member cannot be null");
        if (newName == null || newName.isBlank()) throw new IllegalArgumentException("Name cannot be empty");
