 ...
 * - Add a review after attending a lesson
 * - Query reviews by lesson or member
...
public class ReviewController {
     ...
     * @throws IllegalStateException    if member was not enrolled in the lesson
     * @throws IllegalStateException    if member already reviewed this lesson
    ...
    public Review addReview(Member member, Lesson lesson, int rating, String comment) {
        ...
        if (!lesson.hasMember(member))
            throw new IllegalStateException(
                "Member has not attended this lesson and cannot review it");

        if (hasReviewed(member, lesson))
            throw new IllegalStateException(
                "Member has already submitted a review for this lesson");
    ...
    public boolean hasReviewed(Member member, Lesson lesson) {
        return store.findReviewsByLesson(lesson).stream()
